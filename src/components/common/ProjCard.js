		...
		<View style={styles.containerStyle}>
			<Image style={styles.image} source={props.icon} >
				<View style={{flexDirection:'row'}}>
					<Image style={styles.seenProj} source={require('mawkaaTest/images/google.png')}></Image>
					<Text style={styles.seenNumText}>{props.seenNum}</Text>
					<Image style={styles.saveProj} source={require('mawkaaTest/images/home.png')}></Image>
